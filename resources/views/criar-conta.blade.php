                    ...
                    <div class="column is-4 is-offset-4">
                        ...
                        <div class="box">
                            ...
                            <form method="post">
                                <div class="field">
                                    <div class="control">
                                        <input class="input is-medium" type="text" name="name" value="{{old('name')}}" placeholder="Seu nome" autofocus="true">
                                    </div>
                                </div>
                                <div class="field">
                                    <div class="control">
                                        <input class="input is-medium" type="email" name="email" value="{{old('email')}}" placeholder="Seu email">
                                    </div>
                                </div>
